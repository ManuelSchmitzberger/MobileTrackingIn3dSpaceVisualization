...
//
//public class LiveCapturingMain_ extends GLJPanel implements GLEventListener, KeyListener {
//
//    public static void main(String[] args) {
//        JFrame window = new JFrame("JOGL Scene");
//        GLCapabilities caps = new GLCapabilities(null);
//        LiveCapturingMain_ panel = new LiveCapturingMain_(caps);
...
//
//    public LiveCapturingMain_(GLCapabilities capabilities) {
//        super(capabilities);
